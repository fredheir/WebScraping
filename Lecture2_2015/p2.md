...
2) Combine these responses into a single data.frame

3) write a function that takes an input url to scrape Twitter
4) Write a function that takes an input url to scrape both Twitter and Facebook

5) use lapply and do.call to make a scraper
...
===================
Next week we will do scraping proper. But check out this awesome API:
